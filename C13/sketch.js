var arco , flecha,  cena, gvermelho, grosa, gazul, gverde, gflechas;
...
function draw() {
 background(0);
  ...
  if (gflechas.isTouching(gvermelho)) {
    gvermelho.destroyEach();
    gflechas.destroyEach();
    placar = placar+1000;
  }

  if (gflechas.isTouching(gverde)) {
    gverde.destroyEach();
    gflechas.destroyEach();
    placar = placar+1000;
  }

  if (gflechas.isTouching(grosa)) {
    grosa.destroyEach();
    gflechas.destroyEach();
    placar = placar+1000;
  }
  
  if (gflechas.isTouching(gazul)) {
    gazul.destroyEach();
    gflechas.destroyEach();
    placar = placar+1000;
  }
